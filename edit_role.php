<?php
  ...
  $id = $_GET['id'];
  $result = mysqli_query($conn,"SELECT * FROM role WHERE role_id=$id ");
...
?>
    ...
    <main id="content" role="main" class="main">
          ...
          <div class="col-lg-12 mb-3 mb-lg-12">
            ...
            <div class="card h-100">
              ...
              <div class="card-header">
                <h5 class="card-header-title">Edit Role</h5>
      ...
      $sql = "UPDATE role SET role_name='$name',modified_date=now() 
          WHERE role_id = $id ";
      ...
      ?>
        ...
        window.location.href='view_role.php?w2=updated';
        </script>
      <?php
    }
      ?>      
 ...
 <form method="POST" action="" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" class="form-control" id="exampleInputEmail1"  value="<?php echo $row['role_name']?>">

  </div>
  
  <button type="submit" name="update" class="btn btn-dark float-right">Update</button>
 
  <a href="view_role.php" class="btn btn-outline-dark float-right md-3">Back</a>
</form>
