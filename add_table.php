...
<head>
    ...
    <link rel="stylesheet" href="https://htmlstream.com/front-dashboard/assets/vendor/icon-set/style.css">
  ...
  <body class="footer-offset footer-offset has-navbar-vertical-aside navbar-vertical-aside-show-xl"><header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-flush navbar-container navbar-bordered">
      ...
      <ul class="navbar-nav align-items-center flex-row">
                          ...
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck1" checked="" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck2" checked="" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck4" checked="" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck3" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck5" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck7" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck6" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck8" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck9" type="checkbox">
                      ...
                      <li class="list-group-item custom-checkbox-list-wrapper">
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              <div class="custom-control custom-checkbox custom-checkbox-list">
                                <input class="custom-control-input" id="notificationCheck10" type="checkbox">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          ...
          <div class="hs-unfold">
            ...
            <div id="appsDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu hs-unfold-hidden hs-unfold-content-initialized hs-unfold-css-animation animated" style="width: 25rem; animation-duration: 300ms;" data-hs-target-height="450.05" data-hs-unfold-content="" data-hs-unfold-content-animation-in="slideInUp" data-hs-unfold-content-animation-out="fadeOut">
              <!-- Header -->
              <div class="card-header">
        ...
        <li class="nav-item">
          ...
          <div class="hs-unfold">
            ...
            <div id="accountNavbarDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-account hs-unfold-hidden hs-unfold-content-initialized hs-unfold-css-animation animated" style="width: 16rem; animation-duration: 300ms;" data-hs-target-height="402.4" data-hs-unfold-content="" data-hs-unfold-content-animation-in="slideInUp" data-hs-unfold-content-animation-out="fadeOut">
              ...
              <div class="hs-unfold w-100">
                <a class="js-hs-unfold-invoker navbar-dropdown-submenu-item dropdown-item d-flex align-items-center" href="javascript:;" data-hs-unfold-options="{
                     ...
                     &quot;event&quot;: &quot;hover&quot;
                   }" data-hs-unfold-target="#navSubmenuPagesAccountDropdown2" data-hs-unfold-invoker="">
                  <span class="text-truncate pr-2" title="Customization">Customization</span>
                  <i class="tio-chevron-right navbar-dropdown-submenu-item-invoker  ml-auto"></i>
                </a>

                <div id="navSubmenuPagesAccountDropdown2" class="hs-unfold-content hs-unfold-has-submenu dropdown-unfold dropdown-menu navbar-dropdown-sub-menu hs-unfold-hidden hs-unfold-content-initialized hs-unfold-simple" data-hs-target-height="0" data-hs-unfold-content="">
                  <a class="dropdown-item" href="#">
...
</header><aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered default navbar-vertical-aside-initialized">
      ...
      <div class="navbar-vertical-content">
        <ul class="navbar-nav navbar-nav-lg nav-tabs">
          ...
          <li class="nav-item active">
            <a class="js-nav-tooltip-link nav-link active" href="./welcome-page.html" title="" data-placement="left" data-original-title="Welcome page">
