...
?>
  ...
  <?php
        ...
        <i class="fa fa-exclamation-triangle"> </i> Role Name Required!
        </div>';
                }else{
      $query = $conn->query("INSERT INTO role(role_name,created_by,created_date,modified_date)
      VALUES ('$name','zinmyo',NOW(),NOW())");
        ...
        echo "<script>window.open('view_role.php?w2=success','_self')</script>";
                  }
                }
                }
          ?>
