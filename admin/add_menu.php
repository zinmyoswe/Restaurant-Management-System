...
?>
          ...
          <div class="col-lg-12 mb-3 mb-lg-12">
            ...
            <div class="card h-100">
              ...
              <div class="card-header">
                <h5 class="card-header-title">Add Menu</h5>
  ...
  <?php
      ...
      $query = $conn->query("INSERT INTO menu(menu_name,created_by,modified_by,created_date,modified_date)
      VALUES ('$name','zinmyo','',NOW(),NOW())");
        ...
        echo "<script>window.open('view_menu.php?w2=success','_self')</script>";
                  }
                }
                }
          ?>
