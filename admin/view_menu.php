          ...
          <div class="col-lg-12 mb-3 mb-lg-12">
            ...
            <div class="card h-100">
              ...
              <div class="card-header">
                <h5 class="card-header-title">Manage Menu</h5>
              ...
              <!-- Body -->
              <div class="card-body">
                <a href="add_menu.php" class="btn btn-dark">Add New Menu</a>
            ...
            <table class='table' >
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href='<?= $created_date ?>' target='_blank'><?= $menu_name ?></a></td>
                        <td><?php echo $row['created_by'] ?></td>
                       
                        <td><i class="fal fa-alarm-clock"></i> <?= $created_date ?></td>
                        <td></td>
                        <td align='center'>
                            <a href="edit_menu.php?id=<?php echo $row['menu_id']?>" class="btn btn-outline-primary">Edit</a>
