...
?>
          ...
          <div class="col-lg-12 mb-3 mb-lg-12">
            ...
            <div class="card h-100">
              ...
              <div class="card-header">
                <h5 class="card-header-title">Add Main Ingredient</h5>
  ...
  <?php
        ...
        <i class="fa fa-exclamation-triangle"> </i> Ingredient Name Required!
        </div>';
                }else{
      $query = $conn->query("INSERT INTO main_ingredient(main_ingredient_name,created_date,modified_date)
      VALUES ('$name',NOW(),NOW())");
          ?>
        ...
        echo "<script>window.open('view_ingredient.php?w2=success','_self')</script>";
                  }
                }
                }
          ?>
