...
?>
 ...
 <form method="POST" action="update_menu.php" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" class="form-control" id="exampleInputEmail1"  value="<?php echo $row['menu_name']?>">

  </div>
  
 
  <input type="submit" value="Update" class="btn btn-dark float-right">
  <a href="view_menu.php" class="btn btn-outline-dark float-right md-3">Back</a>
</form>
