...
?>
    ...
    <!--     <form class="js-step-form py-md-5" data-hs-step-form-options="{
                      ...
                      <div class="col-sm-9">
                        <div class="d-flex align-items-center">
                          ...
                          <label class="avatar avatar-xl avatar-circle avatar-uploader mr-5" for="avatarUploader">
                            ...
                            <input class="js-file-attach avatar-uploader-input" id="avatarUploader" data-hs-file-attach-options="{
        ...
        <i class="fa fa-exclamation-triangle"> </i> Menu Name Required!
        </div>';
                }else{
      $query = $conn->query("INSERT INTO staff(firstname,lastname,email)
      VALUES ('$firstname','$lastname','$email')");
        ...
        echo "<script>window.open('add_staff.php?w2=success','_self')</script>";
                  }
                }
                }
          ?>
                    ...
                    <div class="js-add-field row form-group" data-hs-add-field-options="{
                      ...
                      <div class="col-sm-9">
                        <div class="input-group input-group-sm-down-break align-items-center">
                          <input class="js-masked-input form-control" name="phone" id="phoneLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options="{
