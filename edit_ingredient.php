<?php
  ...
  $id = $_GET['id'];
  $result = mysqli_query($conn,"SELECT * FROM main_ingredient WHERE main_ingredient_id=$id ");
...
?>
          ...
          <div class="col-lg-12 mb-3 mb-lg-12">
            ...
            <div class="card h-100">
              ...
              <div class="card-header">
                <h5 class="card-header-title">Edit Main Ingredient</h5>
 ...
 <form method="POST" action="update_ingredient.php" enctype="multipart/form-data">

  <input type="hidden" name="id" value="<?php echo $row['main_ingredient_id']?>">

  <div class="form-group">
    <label for="exampleInputEmail1">Main Ingredient Name</label>
    <input type="text" name="name" class="form-control" id="exampleInputEmail1"  value="<?php echo $row['main_ingredient_name']?>">
